# CLAUDE.md — KKN Tematik STEM 2026

Parent protocol auto-loads from `D:\AT Kuliah\CLAUDE.md` (Universal Session Protocol + Dex-Core). Follow it.
...
- Cross-project status → report to `Dex-Core.md` §13 "KKN" thread + §18.

## Current focus (per 2026-05-29)
Revisi untuk **Pembekalan KKN II (30 Mei)**: anggaran (max Rp 500k, **no** anggaran makanan) + backup plan (sinyal kelas kurang → opsi local server, dll) + proposal disesuaikan. Detail di Dex-Core §13 KKN + §18.
